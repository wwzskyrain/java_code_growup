...
class Customer implements Runnable {
    ...
    public void deliver(Plate p) throws InterruptedException {  //服务员来调用这个deliver，上菜。
    ...
    public void run() {
        for (Course course : Course.values()) {
            ...
            try {
                ...
                //客户用"盘子"去下单，如果有盘子就下单，流程就向下走；没有盘子，就阻塞在这儿——只有一个盘子，一次只能点一道菜，上了吃完了再点。
                //如果用一个"有界阻塞队列-ArrayBlockingQueue"，不就可以实现"点多道菜"了吗？
