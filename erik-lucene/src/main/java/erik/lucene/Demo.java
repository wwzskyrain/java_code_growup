...
//        Query query = new QueryParser(Version.LUCENE_40,"title", analyzer).parse(querystr);
    ...
    public void testCreateIndex() throws IOException{
        ...
        Path indexDocumentPath = FileSystems.getDefault().getPath("index_document");
        Directory directory = FSDirectory.open(indexDocumentPath);
        //索引库还可以存放到内存中
...
//            long fileSize  = FileUtils.sizeOf(file2);
            ...
            //文件内容
            String fileContent = FileUtils.readFileToString(file2.getAbsolutePath());
