...
public class LayoutTest extends JPanel {
    ...
    private GridLayoutPanel gridLayoutPanel = new GridLayoutPanel(CELL_WIDTH, SIDES);
    ...
    private static void createAndShowGui() {
        ...
        frame.getContentPane().add(layoutTest);
        frame.pack();
...
class GridLayoutPanel extends JPanel {
    ...
    public GridLayoutPanel(int cellWidth, int sides) {
        setBackground(BG);
